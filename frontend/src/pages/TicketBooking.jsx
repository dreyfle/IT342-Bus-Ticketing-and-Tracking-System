                ...
                <tbody>
                  {trips.length === 0 && (
                    <tr>
                      <td colSpan="9" className="px-4 py-8 text-center text-gray-500">
                        No bus trips available. Please adjust your filters or check back later.
                      </td>
                    </tr>
                  )}
                  {trips.map((trip, index) => (
                    <tr key={index} className="border-b border-gray-200 hover:bg-blue-50 transition-colors">
                      ...
                      <td className="px-4 py-4 text-sm text-gray-900 border-r border-gray-200 whitespace-pre-line">
                        {trip.departure}
                      </td>
                      ...
                      <td className="px-4 py-4 text-sm text-gray-900 border-r border-gray-200">{trip.seats}</td>
                      <td className="px-4 py-4 text-sm font-semibold text-gray-900">{trip.fare}</td>
                    </tr>
                  ))}
